...
<div class="py-4">
    <h1 class="mb-4"><i class="fas fa-edit text-primary"></i> Edit Event</h1>
                    ...
                    <form method="post" action="<?= base_url('admin/events/update/' . $event['id']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5" 
                                required placeholder="Enter event description"><?= old('description', $event['description']) ?></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control" id="max_participants" name="max_participants" 
                                value="<?= old('max_participants', $event['max_participants']) ?>" required min="1" placeholder="Enter maximum participants">
                        </div>
