 ...
 * Upload class to help identify the allowed file types.
 */
class Mimes extends BaseConfig
{
    ...
    public array $mimes = [
        ...
        'dotx'  => ['application/vnd.openxmlformats-officedocument.wordprocessingml.template', 'application/zip', 'application/msword'],
        ...
        'crt'   => ['application/x-x509-ca-cert', 'application/x-x509-user-cert', 'application/pkcs10'],
        'crl'   => ['application/pkcs-crl', 'application/x-pkcs-crl'],
        ...
        'cer'   => ['application/pkcs7-mime', 'application/x-x509-ca-cert'],
        '3g2'   => 'video/3gpp2',
        ...
        's7z'   => ['application/x-7z-compressed', 'application/x-compressed', 'application/x-zip-compressed', 'application/zip', 'multipart/x-zip'],
        'webp'  => 'image/webp',
